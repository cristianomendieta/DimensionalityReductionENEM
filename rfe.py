...
def train_models(X, y, n_features_list, average_type, experiment, objective=None, num_classes=None):
    ...
    # Perform RFE and train models with selected features
    for n_features in n_features_list:
        ...
        y_pred_selected = model_selected.predict(X_test_transformed.iloc[:, rfe.support_])
        ...
        feature_importance = model_selected.feature_importances_
        plot_feature_importance(selected_features, feature_importance, f"Feature Importance (Top {n_features} Features)")
